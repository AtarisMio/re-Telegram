...
namespace P2P
{
    ...
    public class Client : IDisposable
    {
        ...
        public Client(string serverIP)
        {
            ...
            hostPoint = new IPEndPoint(serverIP, Server.SERVER_LISTENING_PORT);
        ...
        public async void ConnectToServer(string userName, string password)
        {
            ...
            await client.Send(buffer, buffer.Length, hostPoint);
        ...
        public void PaserCommand(string cmdstring)
        {
            ...
            if (args.Length > 0)
            {
                if (string.Compare(args[0], "exit") == 0)
                {
                ...
                else if (string.Compare(args[0], "send") == 0)
                {
                    if (args.Length > 2)
                    {
                ...
                else if (string.Compare(args[0], "getu") == 0)
                {
        ...
        {
            foreach (User user in users.InnerList)
            {
